...
- Insertion operators can be used with the **cin** and **cout** functions to modify their behavior.
...
- Exception errors that occur in a **try** block are automatically thrown to the associated **catch** block.
- Exceptions can be manually thrown to the associated **catch** block using the **throw()** function.
- The C++ **\<stdexcept\>** library defines a number of exception classes that categorize common exceptions.